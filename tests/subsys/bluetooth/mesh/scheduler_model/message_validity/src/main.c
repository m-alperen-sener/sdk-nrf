...
static struct bt_mesh_model_rt_ctx mock_models_elem_rt_ctx[4] = {
	{
		.user_data = &sched_srv,
	},
	{
...
static const struct bt_mesh_model mock_models_elem[4] = {
	{
		.rt = &mock_models_elem_rt_ctx[0],
		.id = BT_MESH_MODEL_ID_SCHEDULER_SRV,
	},
	{
		.rt = &mock_models_elem_rt_ctx[1],
		.id = BT_MESH_MODEL_ID_SCHEDULER_CLI,
	},
	{
		.rt = &mock_models_elem_rt_ctx[2],
		.id = BT_MESH_MODEL_ID_GEN_ONOFF_SRV,
	},
	{
		.rt = &mock_models_elem_rt_ctx[3],
		.id = BT_MESH_MODEL_ID_SCENE_SRV,
	},
};

static struct bt_mesh_elem_rt_ctx mock_elem_rt_ctx = {
	.addr = 1
};
