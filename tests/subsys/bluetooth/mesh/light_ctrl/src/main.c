...
static struct bt_mesh_model_rt_ctx mock_lightness_model_rt_ctx = {.elem_idx = 0};

static const struct bt_mesh_model mock_lightness_model = {.rt = &mock_lightness_model_rt_ctx};
...
static struct bt_mesh_model_rt_ctx mock_ligth_ctrl_model_rt_ctx = {
	.user_data = &light_ctrl_srv,
	.elem_idx = 1,
};

static const struct bt_mesh_model mock_ligth_ctrl_model = {.rt = &mock_ligth_ctrl_model_rt_ctx};
